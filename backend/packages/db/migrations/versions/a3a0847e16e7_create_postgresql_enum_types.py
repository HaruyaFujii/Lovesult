...
down_revision: Union[str, None] = 'd5a995d87a6c'
...
def upgrade() -> None:
    ...
    userstatus_enum = ENUM('IN_LOVE', 'HEARTBROKEN', 'SEEKING', name='userstatus', create_type=False)
    ...
    agerange_enum = ENUM('TEENS', 'TWENTIES', 'THIRTIES', 'FORTIES', 'FIFTIES_PLUS', name='agerange', create_type=False)
